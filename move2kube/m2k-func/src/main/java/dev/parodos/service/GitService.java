...
public interface GitService {
  ...
  Git cloneRepo(String repo, String branch, String token, Path targetDirectory) throws GitAPIException, IOException;
  ...
  void push(Git repo, String token) throws GitAPIException, IOException;
