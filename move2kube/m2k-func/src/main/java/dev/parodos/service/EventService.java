...
public interface EventService {
  void fireEvent(CloudEvent<EventGenerator.EventPOJO> event) throws IOException;
  public class EventGenerator {
    ...
    public static CloudEvent<EventPOJO> createCloudEvent(String workflowId, EventPOJO data, String eventType, String source) {
